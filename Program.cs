                    ...
                    case 1:
                        ...
                        switch (interaction)
                        {
                            ...
                            case 2:
                                ...
                                string who1 = Console.ReadLine();
                                string Lösenord1 = Console.ReadLine();
                                foreach (var who in amazon.aAdministrator)
                                {
                                    who.verifyLogin(who1, Lösenord1);
                                    if (who.LoginStatus == true)
                                    {
                                        Console.WriteLine($"Hej {who1}");
